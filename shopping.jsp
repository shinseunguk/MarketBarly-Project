...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%><%
	...
	List<BarlyVO2> list = dao.all();
	request.setAttribute("item", list);
	BarlyVO2 vo = new BarlyVO2();
	
	int rdm1 = r.nextInt(36)+1;
	int rdm2 = r.nextInt(16)+1;
%>
				...
				<ul class="list">
					...
					<li><div class="item">
							<div class="thumb" style="position: relative;">
								<img src="<%=vo.getImg()%>" alt="My Image">
								<div class="group_btn"
									style="position: relative; right: -240px; top: -70px;">
									<button type="submit" id="basket<%=i %>">
							...
							<a class="info" href="#"><br> <span class="name"><%=vo.getTitle()%></span><br>
								<br> <span class="cost"><fmt:formatNumber
										type="number" maxFractionDigits="3" value="${price}"
										var="commaPrice" /> ${commaPrice} 원 </span><br> <br> <span
								class="desc"><%=vo.getContent()%></span><br> <br> </a>
						</div></li>
					<%
						}
					%>
