...
public class DBConnectionMgr {
	//Vector은 arrayList 같은 개념이다. 
    private Vector connections = new Vector(10);//커넥션을 다 넣어두고 사용하는 개념이다.
    private String _driver = "com.mysql.jdbc.Driver",
    _url = "jdbc:mysql://127.0.0.1:3366/barly?useUnicode=true&characterEncoding=utf8",
    _user = "root",
    _password = "1234";
